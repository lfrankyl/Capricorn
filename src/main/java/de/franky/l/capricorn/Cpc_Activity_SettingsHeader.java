...
public class Cpc_Activity_SettingsHeader extends PreferenceActivity
...
*/
    ...
    public void onBuildHeaders(List<Header> target) 
    {
        ...
        loadHeadersFromResource(R.xml.cpc_pref_settings_header, target);
    }
    ...
    protected boolean isValidFragment (String fragmentName) 
    {
		...
		// Log.d("isValidFragment", Cpc_Settings_Frag_Impr.class.getName());
		return Cpc_Settings_Frag_Wid_View_Pos.class.getName().equalsIgnoreCase(fragmentName) ||
    		 Cpc_Settings_Frag_Wlan.class.getName().equals(fragmentName) ||
    		 Cpc_Settings_Frag_Cost_Rel_Data.class.getName().equals(fragmentName) ||
    		 Cpc_Settings_Frag_Gen.class.getName().equals(fragmentName);
    }
	@Override
	...
	private void ContinueAfterClosingSettingsDialog()
	{
