...
* <ul>
* <li>{@link #getDevices(android.content.Context)} liefert eine Liste aller Geraete inklusive der
...
* setUse...(...false) aufgerufen), fuehrt {@link #initDevices(android.content.Context)} einen Rescan
...
* {@link android.os.storage.StorageManager}, die hier per Reflection herausgefuehrt ist.</p>
*
...
public class Cpc_Utils_CT 
{
	...
	* man per {@link Cpc_Utils_CT.Device#isAvailable()}. Die Liste ist
	* somit eher als Geraete-Uebersicht nuetzlich.
	*
	* @see Cpc_Utils_CT.Device
	*
	* @param context Context des Aufrufers, also this oder in Fragments getActivity()
	* @return eine Liste der passenden {@link Cpc_Utils_CT.Device}
	*/
