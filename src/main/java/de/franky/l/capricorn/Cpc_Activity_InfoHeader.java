...
public class Cpc_Activity_InfoHeader extends PreferenceActivity
...
protected void onCreate(Bundle savedInstanceState)
{
    ...
    setTitle(R.string.pref_Impressum_Title);
    try
    {
    ...
    // should not appear
    getFragmentManager().beginTransaction().replace(android.R.id.content, new Cpc_Settings_Frag_Impr()).commit();
